...
Complete guide for using Panda with OpenAI Codex.
...
```
Fetch and follow instructions from https://raw.githubusercontent.com/obra/panda/refs/heads/main/.codex/INSTALL.md
```
...
```bash
mkdir -p ~/.codex/panda
git clone https://github.com/obra/panda.git ~/.codex/panda
```

#### 2. Install Bootstrap

The bootstrap file is included in the repository at `.codex/panda-bootstrap.md`. Codex will automatically use it from the cloned location.
...
```
Run ~/.codex/panda/.codex/panda-codex find-skills to show available skills
```
...
```
Run ~/.codex/panda/.codex/panda-codex find-skills
```

### Loading a Skill

```
Run ~/.codex/panda/.codex/panda-codex use-skill panda:brainstorming
```

### Bootstrap All Skills

```
Run ~/.codex/panda/.codex/panda-codex bootstrap
```
...
**Location:** `~/.codex/panda/.codex/panda-codex`
...
**Location:** `~/.codex/panda/lib/skills-core.js`
...
- `Skill` tool → `~/.codex/panda/.codex/panda-codex use-skill`
...
1. Verify installation: `ls ~/.codex/panda/skills`
2. Check CLI works: `~/.codex/panda/.codex/panda-codex find-skills`
3. Verify skills have SKILL.md files

### CLI script not executable

```bash
chmod +x ~/.codex/panda/.codex/panda-codex
```
