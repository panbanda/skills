...
mkdir -p "$HOME/.config/opencode/panda"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/panda/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/panda/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/panda/.opencode/plugin"
cp "$REPO_ROOT/.opencode/plugin/panda.js" "$HOME/.config/opencode/panda/.opencode/plugin/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugin"
ln -sf "$HOME/.config/opencode/panda/.opencode/plugin/panda.js" \
       "$HOME/.config/opencode/plugin/panda.js"
...
echo "Plugin installed to: $HOME/.config/opencode/panda/.opencode/plugin/panda.js"
echo "Plugin registered at: $HOME/.config/opencode/plugin/panda.js"
